...
Принято:
• фреймворк Laravel установлен успешно;
• в браузере по адресу http://localhost:8080 отображается информационная страница о фреймворке Laravel.

На доработку:
• выполнены не все пункты задания;
• действия выполнены с ошибками.
```
</details>
